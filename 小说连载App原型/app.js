...
const syncToggle = document.querySelector('#syncToggle'); const syncOn = localStorage.getItem('mojian-sync') !== 'off'; syncToggle.checked = syncOn; const syncStatus = document.querySelector('#syncStatus'); const autoSyncCopy = syncToggle.closest('.setting-row').querySelector('div p'); autoSyncCopy?.remove(); syncToggle.closest('.setting-row').querySelector('div').append(syncStatus); setSyncStatus('需登录同步账户');
